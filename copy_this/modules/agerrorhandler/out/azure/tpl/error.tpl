<html>
    <head>
        ...
        <title>[{ $exception->message|nl2br }]</title>
        <link href="[{$oViewConf->getModuleUrl('agerrorhandler')}]out/azure/src/css/error.css" rel="stylesheet" type="text/css" media="all" />
    </head>
    <body>
    <div id="content">
        ...
        <div class="sf-reset">
            <div class="block-exception">
                <div class="block-exception-detected clear-fix">
                    ...
                    <div class="text-exception">
                        ...
                        <div>
                            <strong>[{ $exception->code }]</strong> - [{ $exception->class }]
                        </div>
            ...
            [{ include file="traces.tpl" exception=$exception position="1"}]
